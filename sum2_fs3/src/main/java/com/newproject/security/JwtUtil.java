...
public class JwtUtil {
    ...
    // Inyeccion de la clave secreta desde application.properties
    ...
    // Generar un token JWT con el nombre de usuario y rol
    public String generateToken(String username, String role) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("role", role);  // Agregar el rol del usuario al token
